...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/MovieSearchGroupHD')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002380335187'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002412021360')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002380335187'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002090374492')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002152101562'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002412021360') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002412021360')) # 
...
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/How2download_Cpflix_Files/4")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/How2download_Cpflix_Files/7")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How2download_Cpflix_Files/8")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "b6ee208ecefd4ddab3779fea463b9c7e17abea5b")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'adcash.in')
SHORTENER_API2 = environ.get("SHORTENER_API2", "f6de102a0a367c081221ed9e74fd1147929c363c")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'shortyfi.link')
SHORTENER_API3 = environ.get("SHORTENER_API3", "37f6443b39b5f26c4315a2fe250a1faf75caf3b7")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/ghl.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/faR.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/fOX.jpg'))
REACTIONS = ["😎"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
